...
//   2. things you chose beat things that happened to you. catching an STI, or
//      having a nude passed around: both near the floor.
...
// the family and animal clusters are the exception: umbrella first, top-ups
// under it, so the maths stays readable.
...
const QUESTIONS = [
    ...
    { w: 0.4, c: 'affection', q: "Been someone's first kiss?", t: 'You were theirs.' },
    { w: 0.4, c: 'affection', q: 'Had a crush on a friend and never told them?', t: 'It passed, or it did not.' },
    ...
    { w: 0.8, c: 'solo', q: 'Edged, or held off on purpose?', t: 'Stopped, then started again.' },
    ...
    { w: 0.8, c: 'partnered', q: 'Kissed someone you had only just met?', t: 'That night, at that party.' },
    ...
    { w: 0.8, c: 'partnered', q: 'Faked an orgasm?', t: 'Convincingly, you hoped.' },
    ...
    { w: 1.5, c: 'partnered', q: 'Had a friends-with-benefits arrangement?', t: 'Recurring, no label.' },
    { w: 1.5, c: 'partnered', q: 'Had sex on a first date?', t: 'Or before there was one.' },
    { w: 1.5, c: 'partnered', q: 'Had sex with an ex after breaking up?', t: 'Once it was already over.' },
    ...
    { w: 4,   c: 'partnered', q: 'Had sexual contact with a family member?', t: 'Any degree. The three below add to this one.' },
    ...
    { w: 4,   c: 'partnered', q: 'Had sexual contact with an animal?', t: 'Any. The one below adds to this one.' },
    ...
    { w: 2.5, c: 'kink', q: 'Done knife, needle or blood play?', t: 'Skin marked or pierced in a scene.' },
    { w: 2.5, c: 'kink', q: 'Fisted a partner, or taken something that size?', t: 'Vaginal or anal. Objects count.' },
    ...
    { w: 0.8, c: 'digital', q: 'Had phone or video sex?', t: 'Live, camera optional.' },
    ...
    { w: 1.5, c: 'digital', q: 'Screenshotted a nude someone sent you?', t: 'You still have it.' },
    ...
    { w: 1.5, c: 'substances', q: 'Had a hangover bad enough to miss something?', t: 'Work, class, a plan.' },
    ...
    { w: 6,   c: 'legal', q: 'Sexually assaulted or raped someone?', t: 'Without consent. Not regret.' },
    ...
    { w: 1.5, c: 'risk', q: 'Had sex in the family home with someone else in?', t: 'Quietly.' },
